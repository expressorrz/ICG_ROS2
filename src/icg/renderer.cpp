...
const std::vector<std::shared_ptr<icg::Body>>& icg::Renderer::referenced_body_ptrs() const {
    static const std::vector<std::shared_ptr<icg::Body>> empty_body_ptrs;
    return empty_body_ptrs;
}
